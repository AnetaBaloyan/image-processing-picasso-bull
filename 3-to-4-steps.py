...
plate3 = os.path.realpath('Picasso-bull-plates/picasso_bull_plate_3.jpg')
plate4 = os.path.realpath('Picasso-bull-plates/picasso_bull_plate_4.jpg')
step_log = os.path.normpath(os.path.join(os.path.realpath(__file__), '../3-to-4-steps-python'))
# print(step_log)

bull3 = cv.imread(plate3, cv.IMREAD_GRAYSCALE)
bull3 = bull3[3:, 3:] # I measured manually that to precisely align the two plates, plate 3 must be shifted 3 pixels upwards and to thr right.
